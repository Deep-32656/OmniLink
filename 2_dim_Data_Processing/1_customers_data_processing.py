...
# MAGIC %run /Workspace/Users/deepakyadav32656@gmail.com/consolidated_pipeline/1_setup/utilities
...
# prev_path = f's3://sportsbar-final/{data_source}/*.csv'
...
# MAGIC %md
# MAGIC Drop those duplicate values
...
# MAGIC %md
# MAGIC Remove those trim values
...
# MAGIC %md
# MAGIC Business Confirmation Note: City corrections confirmed by business team
...
# MAGIC %md
# MAGIC Final Store into Silver layer
...
# MAGIC %md
# MAGIC Final Store into Gold layer
